...
export default function HeaderDashboard({ordens, setOrdens}) {
        ...
        <>
            <header className="headerDashboard">
                ...
                <div>
                    ...
                    <ButtonNew title="Nova ordem" onClick={() => {
                        setVisible(true)
                    }} />
            ...
            <Dialog closable={false} header="ORDEM DE SERVIÇO" style={{ width: '60vw' }} visible={visible}>
